...
lemma mono_subset_replace_set: "((\<subseteq>) \<Rrightarrow>\<^sub>m (\<subseteq>)) (\<lambda>A. {y | x \<in> A, P x y})"
  by (intro dep_mono_wrt_relI Dep_Fun_Rel_relI) (auto elim!: replaceE)
