...
are defined inductively. The von Neumann integer \isa{{\isadigit{0}}} is defined to be the empty set, 
and there are no smaller von Neumann integers. The von Neumann integer \isa{N} is then the set of 
all von Neumann integers less than \isa{N}. Further details can be found in
...
We follow the definition from \cite{ZFC_in_HOL_AFP}, \url{https://foss.heptapod.net/isa-afp/afp-devel/-/blob/06458dfa40c7b4aaaeb855a37ae77993cb4c8c18/thys/ZFC_in_HOL/ZFC_in_HOL.thy\#L601}.
 \isa{X} is an ordinal if it is \isa{mem{\isacharunderscore}{\kern0pt}trans{\isacharunderscore}{\kern0pt}closure} and same for its elements.%
\end{isamarkuptext}\isamarkuptrue%
...
%
\begin{isamarkuptext}%
This lemma proves that a property \isa{P} holds for all ordinals using ordinal induction 
