...
lemma set_bijection_on_pred_iff_bijection_on_pred_uhint [uhint]:
  assumes "f \<equiv> eval f'"
  and "g \<equiv> eval g'"
  and "P \<equiv> P'"
  and "Q \<equiv> Q'"
  shows "bijection_on (P :: set \<Rightarrow> bool) (Q :: set \<Rightarrow> bool) f g \<equiv> bijection_on P' Q f' g'"
  using assms by simp
