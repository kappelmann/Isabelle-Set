...
theory Auto2_HOTG
  imports
    Auto2_HOTG_Setup
    Auto2_HOL.Auto2_HOL_Extra_Setup
...
ML_file \<open>auto2_hotg_util_base.ML\<close>
ML\<open>
  ...
  structure Auto2_Setup = Auto2_Setup(
    structure Auto2_Keywords = Auto2_Keywords;
    structure UtilBase = Auto2_HOTG_UtilBase;
  );
\<close>
...
ML\<open>
  ...
  structure Auto2_HOTG_Extra_Setup = Auto2_HOL_Extra_Setup(
    structure Auto2_Setup = Auto2_Setup;
    structure Unfolding_Keyword = Unfolding_Keyword;
    structure Induct_ProofSteps_Keywords = Induct_ProofSteps_Keywords;
  );
\<close>
method_setup auto2 =
  \<open>Scan.succeed (SIMPLE_METHOD o Auto2_Setup.Auto2.auto2_tac)\<close> "auto2 prover"

ML\<open>
  open Auto2_HOTG_Basic_UtilBase
  ...
  open Auto2_HOTG_Extra_Setup.Extra_HOL

  val add_strong_induct_rule = Auto2_HOTG_Extra_Setup.Induct_ProofSteps.add_strong_induct_rule
  val add_case_induct_rule = Auto2_HOTG_Extra_Setup.Induct_ProofSteps.add_case_induct_rule
  val add_prop_induct_rule = Auto2_HOTG_Extra_Setup.Induct_ProofSteps.add_prop_induct_rule
  val add_var_induct_rule = Auto2_HOTG_Extra_Setup.Induct_ProofSteps.add_var_induct_rule
  val add_fun_induct_rule = Auto2_HOTG_Extra_Setup.Induct_ProofSteps.add_fun_induct_rule
  val add_cases_rule = Auto2_HOTG_Extra_Setup.Induct_ProofSteps.add_cases_rule
\<close>
