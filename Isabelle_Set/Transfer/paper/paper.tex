...
%\end{figure}
This definition subsumes all transfer relations accepted by the lifting tool
because the Z-property is satisfied by all right-unique and right-total relations.
Since the transfer tool accepts all binary relations as transfer relations,
it also accepts \liftrels.
