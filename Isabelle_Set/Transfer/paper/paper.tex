...
and the and the co-domains of \liftrels (in other words, we cannot select a \liftrel based on the target's Pure-type).
...
\end{equation*}
where
\kevin{we need to simplify this and rephrase it in a ``morraly correct'' way}
\begin{align*}
...
\end{align*}
To show \(\mathsf{T_{div}}\ \mathsf{div_{\inte rep}}\ (\mapfun\ \rep_\inte\ (\mapfun\ \abs_\inte\ \rep_\inte))\ \mathsf{div_{\inte rep}}\), \kevin{something is wrong here...?}
it remains to prove
\begin{enumerate}
