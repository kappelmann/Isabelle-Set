...
lemma "{} : empty \<sqdot> set" unfolding empty_def adjective_def by unfold_types auto
lemma "{a} : non-empty \<sqdot> set" unfolding non_def empty_def adjective_def by unfold_types auto
