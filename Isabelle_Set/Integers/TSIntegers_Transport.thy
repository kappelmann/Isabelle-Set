...
lemma Int_Rep_nonneg_parametric [trp_in_dom]:
  ...
  unfolding Int_Rep_nonneg_def int_rep_def by (intro Fun_Rel_relI) auto
...
lemma Int_Rep_neg_parametric [trp_in_dom]:
  ...
  unfolding Int_Rep_neg_def int_rep_def by (intro Fun_Rel_relI) auto
...
lemma "Int_Rep_if \<Ztypecolon> (Int_Rep \<Rightarrow> Bool) \<Rightarrow> Int_Rep \<Rightarrow> A \<Rightarrow> A \<Rightarrow> A"
...
lemma Int_Rep_if_parametric [trp_in_dom]:
  ...
  unfolding Int_Rep_if_def by (intro Fun_Rel_relI) auto
...
lemma app_eq_Int_Rep_zero_type:
  "app_eq_Int_Rep_zero \<Ztypecolon> (A \<Rightarrow> Int_Rep) \<Rightarrow> A \<Rightarrow> Bool"
  by discharge_types

lemma app_eq_Int_Rep_parametric [trp_in_dom]:
  "((R \<Rrightarrow> Int.L) \<Rrightarrow> (R :: _ \<Rightarrow> _ \<Rightarrow> bool) \<Rrightarrow> (\<longleftrightarrow>)) app_eq_Int_Rep_zero app_eq_Int_Rep_zero"
  unfolding app_eq_Int_Rep_zero_def
  by (intro Fun_Rel_relI) force
