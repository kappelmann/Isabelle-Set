...
begin
  definition "rel_injective_on_type (T :: 'a type) :: ('a \<Rightarrow> 'b \<Rightarrow> bool) \<Rightarrow> bool \<equiv>
    rel_injective_on (of_type T)"
end

lemma rel_injective_on_type_eq_rel_injective_on_pred [simp]:
  "(rel_injective_on (T :: 'a type) :: ('a \<Rightarrow> 'b \<Rightarrow> bool) \<Rightarrow> bool) = rel_injective_on (of_type T)"
...
lemma rel_injective_on_type_iff_rel_injective_on_pred [iff]:
  "rel_injective_on (T :: 'a type) (R :: 'a \<Rightarrow> 'b \<Rightarrow> bool) \<longleftrightarrow> rel_injective_on (of_type T) R"
  by simp
...
begin
  definition "rel_injective_at_type (T :: 'a type) :: ('b \<Rightarrow> 'a \<Rightarrow> bool) \<Rightarrow> bool \<equiv>
    rel_injective_at (of_type T)"
end

lemma rel_injective_at_type_eq_rel_injective_at_pred [simp]:
  "(rel_injective_at (T :: 'a type) :: ('b \<Rightarrow> 'a \<Rightarrow> bool) \<Rightarrow> bool) = rel_injective_at (of_type T)"
...
lemma rel_injective_at_type_iff_rel_injective_at_pred [iff]:
  "rel_injective_at (T :: 'a type) (R :: 'b \<Rightarrow> 'a \<Rightarrow> bool) \<longleftrightarrow> rel_injective_at (of_type T) R"
  by simp
