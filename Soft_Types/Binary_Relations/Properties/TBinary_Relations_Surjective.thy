...
begin
  definition "rel_surjective_at_type (T :: 'a type) :: ('b \<Rightarrow> 'a \<Rightarrow> bool) \<Rightarrow> bool \<equiv>
    rel_surjective_at (of_type T)"
end

lemma rel_surjective_at_type_eq_rel_surjective_at_pred [simp]:
  "(rel_surjective_at (T :: 'a type) :: ('b \<Rightarrow> 'a \<Rightarrow> bool) \<Rightarrow> bool) = rel_surjective_at (of_type T)"
...
lemma rel_surjective_at_type_iff_rel_surjective_at_pred [iff]:
  "rel_surjective_at (T :: 'a type) (R :: 'b \<Rightarrow> 'a \<Rightarrow> bool) \<longleftrightarrow> rel_surjective_at (of_type T) R"
  by simp
