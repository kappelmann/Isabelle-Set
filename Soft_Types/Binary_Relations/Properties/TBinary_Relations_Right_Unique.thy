...
begin
  definition "right_unique_on_type (T :: 'a type) :: ('a \<Rightarrow> 'b \<Rightarrow> bool) \<Rightarrow> bool \<equiv>
    right_unique_on (type_pred T)"
end

lemma right_unique_on_type_eq_right_unique_on_pred [simp]:
  "(right_unique_on (T :: 'a type) :: ('a \<Rightarrow> 'b \<Rightarrow> bool) \<Rightarrow> bool) = right_unique_on (type_pred T)"
...
lemma right_unique_on_type_iff_right_unique_on_pred [iff]:
  "right_unique_on (T :: 'a type) (R :: 'a \<Rightarrow> 'b \<Rightarrow> bool) \<longleftrightarrow> right_unique_on (type_pred T) R"
  by simp
...
begin
  definition "right_unique_at_type (T :: 'a type) :: ('b \<Rightarrow> 'a \<Rightarrow> bool) \<Rightarrow> bool \<equiv>
    right_unique_at (type_pred T)"
end

lemma right_unique_at_type_eq_right_unique_at_pred [simp]:
  "(right_unique_at (T :: 'a type) :: ('b \<Rightarrow> 'a \<Rightarrow> bool) \<Rightarrow> bool) = right_unique_at (type_pred T)"
...
lemma right_unique_at_type_iff_right_unique_at_pred [iff]:
  "right_unique_at (T :: 'a type) (R :: 'b \<Rightarrow> 'a \<Rightarrow> bool) \<longleftrightarrow> right_unique_at (type_pred T) R"
  by simp
